...
@CucumberOptions(features = "classpath:features", plugin = {"pretty", "html:target/cucumber-html-report.html",
        "json:target/cucumber.json"}, tags ="@tc11", monochrome = true
)

public class RunCukesTest extends AbstractTestNGCucumberTests {

    public static ExtentTest logger;
    public static java.lang.String tagName = null;
    ...
    public void directoryCleanUp() {
        try {
            ...
            java.lang.String filePath = System.getProperty("user.dir") + File.separator + ConfigReader.getValue("screenshotPath");
    ...
    public void onFinish() {
        ...
        extent.close();
        try {
            java.lang.String filePathBackup = System.getProperty("user.dir") + File.separator + "ExecutionReports"
