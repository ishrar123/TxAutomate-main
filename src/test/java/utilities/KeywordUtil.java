...
//		}
    ...
    public static void navigateToUrl(String url) {
        ...
        try {
            ...
            RunCukesTest.logger.log(LogStatus.INFO, HTMLReportUtil.infoStringGreyColor("Application URL=" + url));
            getDriver().get(url);
...
// ......
    ...
    public static String getAttributevaue(By locator,String value){
        KeywordUtil.lastAction = "Get Element value: " + locator.toString();
        LogUtil.infoLog(KeywordUtil.class, KeywordUtil.lastAction);
        WebElement elm = waitForClickable(locator);
        return elm.getAttribute(value);
    ...
    public static String getElementValueWithVisibile(By locator) {
        KeywordUtil.lastAction = "Get Element value: " + locator.toString();
        LogUtil.infoLog(KeywordUtil.class, KeywordUtil.lastAction);
        WebElement elm = getDriver().findElement(locator);
        return elm.getAttribute("value");
